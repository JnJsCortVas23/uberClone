...
const TrackingScreen = ({ route, navigation }) => {
    ...
    const statusConfig = useMemo(() => ({
        searching: { emoji: '🔍', text: 'Buscando conductor...', color: COLORS.gray },
        arriving:  { emoji: '🚗', text: 'Tu conductor está en camino', color: COLORS.primary },
        arrived:   { emoji: '✅', text: '¡Tu conductor ha llegado!', color: '#27AE60' },
    }), []);
            ...
            <View style={styles.panel}>
                ...
                <Text style={styles.progressText}>
                    {status === 'arrived'
                        ...
                        : `Conductor aproximándose... ${Math.round((stepIndex / routeSteps.length) * 100)}%`}
                </Text>
                ...
                <TouchableOpacity
                    ...
                    <Text style={styles.actionButtonText}>
                        {status === 'arrived' ? '¡Iniciar viaje!' : 'Cancelar viaje'}
                    </Text>
                </TouchableOpacity>
            </View>
        </View>
